...
public class Vodafone implements Paytm {
	...
	static{
		...
		registeredMobileNumbers.put(9838464655l,150);
		registeredMobileNumbers.put(9839452135l,500);
		registeredMobileNumbers.put(9956102030l,20);
		registeredMobileNumbers.put(9896556677l,10);
	}
	...
	public void denomination() {
		...
		System.out.println("384 Rs for 3 month free unlimited call and 1.5 GB data per day");
